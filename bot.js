...
await bot.sendPhoto(
chatId,
"https://files.manuscdn.com/user_upload_by_module/session_file/310519663878790151/TxTwdINKyeieQcFI.jpg",
{
caption: `🪀 *𝙏𝙝𝙚 ꨄ 𝙓 𝙉𝙊𝘽𝙄𝙏𝘼 𝙈𝘿 ꨄ*\n\n╔════════════════════╗\n ⤷ /pair <wa_number>\n ⤷ /unpair <wa_number>\n╚════════════════════╝`,
parse_mode: 'Markdown',
reply_markup: {
inline_keyboard: [
[{ text: "👑 Owner", url: "https://t.me/Nobitaxudi" }]
]
}
}
);
...
`🔐 *Please send your WhatsApp number*\n\nExample: /pair 917337211743\n\nOr just type: 917337211743`,
{ parse_mode: 'Markdown' }
);
}
...
try {
if (!input) {
return bot.sendMessage(chatId, 'Example: /unpair 917337211743', { parse_mode: 'Markdown' });
}
if (/[a-z]/i.test(input)) {
return bot.sendMessage(chatId, 'Letters not allowed. Use: /unpair 917337211743', { parse_mode: 'Markdown' });
}
if (!/^\d{7,15}$/.test(input)) {
return bot.sendMessage(chatId, 'Invalid format. Use: /unpair 917337211743', { parse_mode: 'Markdown' });
}
...
console.log('✅ Bot Username: @xnobita_md_bot');
