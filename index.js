/**
   * Create By X NOBITA MD
   * Contact Me on 917337211743
*/
const fs = require('fs');
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃', {
        font: 'Standard',
    ...
    console.log(chalk.green('   𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting 𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅ X NOBITA MD Telegram bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅ 𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 Telegram bot: Active') : chalk.red('❌ 𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 Telegram bot: Inactive'));
    console.log(chalk.cyan('═══════════════════════════════════════════════\n'));

    if (!telegramLoaded) {
        console.log(chalk.red('⚠️  Warning: No bot systems loaded! Check your files.\n'));
    } else {
        console.log(chalk.green('✅ 𝐗 𝐍𝐎𝐁𝐈𝐓𝐀 𝐌𝐃 system is ready and running!\n'));
    }
